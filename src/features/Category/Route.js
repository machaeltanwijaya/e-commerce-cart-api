...
import { createCategorySchema, updateCategorySchema, getCategoryQuerySchema } from "./Schema.js";
...
categoryRouter.get("/", validate(getCategoryQuerySchema, "query"), categoryController.getAllCategories);
